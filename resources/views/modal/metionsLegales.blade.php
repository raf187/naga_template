<div class="modal" tabindex="-1" id="mentionsLegales" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content  col-md-12">
            <div class="modal-header px-5">
                <h5 class="modal-title font-weight-bold">MENTIONS LÉGALES ET RGPD</h5>
            ...
            <div class="modal-body p-5">
                <div class="content">
                    <h5 class="font-weight-bold">FAT CHOY</h5>
                    <p>SARL au capital de 5000€<br>
                        76, Boulevard de la Madeleine<br>
                        06000 Nice<br>
                        SIRET : 89323230600017<br>
                        TVA : FR53893232306<br></p>
                </div>
                <div class="content">
                    <h3>Informations l&eacute;gales Conform&eacute;ment &agrave; la loi "Informatique et Libert&eacute;s"</h3>
                    <p>Le traitement des informations nominatives relatives aux clients a fait l'objet d'une d&eacute;claration aupr&egrave;s de la Commission Nationale de l'Informatique et des Libert&eacute;s (CNIL).<br /><br />Nous vous rappelons que vous disposez d'un droit d'acc&egrave;s, de modification, de rectification et de suppression des donn&eacute;es qui vous concernent (art. 34 de la loi "Informatique et Libert&eacute;s" du 6 janvier 1978).<br /><br />Pour l'exercer, adressez-vous par &eacute;crit &agrave; votre restaurant.<br />Les photographies et illustrations pr&eacute;sent&eacute;es en ligne et sur nos brochures ne sont pas contractuelles.<br /><br />Nous ne pouvons vous garantir une absence totale d'allerg&egrave;nes dans nos produits.<br /><br />L'abus d'alcool est dangereux pour la sant&eacute;, sachez consommer avec mod&eacute;ration.</p>
                    <p>&nbsp;</p>
                    <h4>NOS ENGAGEMENTS EN MATI&Egrave;RE DE PROTECTION DE VOS DONN&Eacute;ES PERSONNELLES</h4>
                    ...
                    <h4>A QUELLES OCCASIONS COLLECTONS-NOUS VOS DONN&Eacute;ES PERSONNELLES ?<strong><br /> </strong></h4>
                    ...
                    <h4>QUELLES SONT LES INFORMATIONS PERSONNELLES QUE NOUS COLLECTONS ?<strong><br /></strong><br /> Nous collectons les informations que vous nous fournissez dans le cadre de notre relation commerciale notamment :</h4>
                    <ul>
                    ...
                    <h4>COMMENT UTILISONS-NOUS VOS DONN&Eacute;ES ?<strong><br /> <br /> </strong></h4>
                    ...
                    <h4>QUI SONT LES DESTINATAIRES DE VOS DONN&Eacute;ES PERSONNELLES ?<strong><br /> <br /> </strong></h4>
                    ...
                    <h4>O&Ugrave; SONT STOCK&Eacute;ES VOS DONN&Eacute;ES PERSONNELLES ?<strong><br /> </strong></h4>
                    ...
                    <table border="2px" width="100%" cellspacing="10px" cellpadding="10px"><caption>&nbsp;</caption>
                        <thead>
                        <tr>
                            <td width="288">
                    ...
                    <h5><em>Nâga Nice<br /></em><em>76, Boulevard de la Madeleine<br /></em><em>06000 Nice&nbsp</em></h5>
                    ...
                    <p>Notre d&eacute;l&eacute;gu&eacute; &agrave; la protection des donn&eacute;es personnelles (DPO) est disponible pour r&eacute;pondre &agrave; vos questions &agrave; l&rsquo;adresse suivante : contact@naga-nice.com</p></div>
            </div>
