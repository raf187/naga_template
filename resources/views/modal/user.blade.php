            ...
            <div class="modal-body col-md-10 offset-md-1">
                ...
                <form id="updateUserForm" method="POST" action="/user-update">
                    ...
                    <div class="form-group">
                        ...
                        <input list="addressAPIupdate" id="updateAddress" type="text" class="updateUser form-control bg-white border-bottom @error('updateAddress') is-invalid @enderror"
                               name="updateAddress" value="{{ Auth::user()->address ?? "" }}" data-val="no" placeholder="Ex: 30 rue du pont 06560 Sophia Antipolis" readonly>
                        <datalist id="addressAPIupdate">
                        </datalist>
                        <small class="font-italic text-muted updateRayonMsg">Rayon de livraison de 2,5km maximun</small>
                        <span class="d-none updateAlertDelivery"></span>
                        <input id="updateAdressVal" name="updateAdressVal" type="hidden" value="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="updateDeliInfo" type="text" class="updateUser form-control bg-white border-0 @error('updateDeliInfo') is-invalid @enderror"
                                  ...
                                  autofocus placeholder="Laisser à l'accueill, appler avant de arriver ..." readonly>{{ Auth::user()->deliInfo ?? "" }}</textarea>
